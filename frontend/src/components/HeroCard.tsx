...
export default function HeroCard() {
  return (
    <section className="overflow-hidden rounded-[2rem] border border-[var(--border-soft)] bg-[var(--surface-raised)] shadow-[0_30px_80px_rgba(30,45,56,0.08)]">
      <div className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr]">
        <div className="px-6 py-8 sm:px-8 sm:py-10">
          <p className="text-[11px] font-semibold uppercase tracking-[0.24em] text-[var(--text-muted)]">
            One Ayah Forward
          </p>
          <h1 className="mt-3 text-3xl font-semibold tracking-tight text-[var(--text-strong)] sm:text-5xl">
